...
- A desktop workspace with collapsible generation, history, and LoRA panes, plus an optional fullscreen mode
- A phone-first fullscreen interface with separate Create, Prompt, Tune, LoRAs, Stack, and History tabs
...
- An always-visible generation action and current-output workspace
