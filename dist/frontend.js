...
export function setup(ctx) {
    ...
    const selectTheme = (theme)=>{
        ...
        if (launcher) {
            ...
            for (const swatch of launcher.querySelectorAll("[data-theme-choice]")){
    ...
    launcherTitle.append(element("div", "ss-launcher-eyebrow", "Local image atelier"), element("h3", "", "Imagine with SwarmUI"));
    ...
    const flowItems = [
        [
            "01",
            "Compose",
            "Prompt with presets, img2img, and model-aware controls."
        ],
        [
            "02",
            "Layer",
            "Browse visual metadata and build reusable LoRA stacks."
        ],
        [
            "03",
            "Keep",
            "Inspect, reuse, search, folder, or delete Lumiverse outputs."
        ]
    ];
