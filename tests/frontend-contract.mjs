...
assert.match(source, /character 1: smiling, holding a paper tray/)
assert.match(source, /character 2: amused expression, leaning closer/)
assert.match(source, /interaction: character 1 offers character 2 a bite/)
