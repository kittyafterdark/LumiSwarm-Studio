...
assert.match(source, /Bind visual identity\./)
...
assert.match(source, /ss-library-mobile-close[\s\S]*?data-action="close-output-library"/)
...
assert.match(source, /\.ss-library-head \.ss-muted \{[\s\S]*?min-width: 0;[\s\S]*?text-overflow: ellipsis/)
