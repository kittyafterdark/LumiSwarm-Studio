...
assert.match(source, /data\.status === "ready"[\s\S]*?this\.settleTaggedJob\(jobId\)/)
assert.match(source, /case "tagged_generation_result"[\s\S]*?this\.settleTaggedJob\(taggedJobId\)/)
